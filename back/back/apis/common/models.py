...
from mongoengine import EmbeddedDocument, IntField, SequenceField, NotUniqueError, SortedListField, ListField, ValidationError
...
class AddressSchema(FlaskSchema):
    x = fields.Int(required=True, strict=True)
    y = fields.Int(required=True, strict=True)
